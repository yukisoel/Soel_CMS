...
const PostDetailModal = ({ isOpen, onClose, post }: Props) => {
    ...
    return (
        <div className={styles.modal_overlay}>
            <div className={styles.modal_wrapper}>
                <Wrapper gap="2.2rem">
                    <img src={ModalNavIcon} alt="modal nav icon" width="38px" height="662px" />
                    ...
                    <img src={ModalNavIcon} alt="modal nav icon" width="38px" height="662px" className={styles.next_button} />
                </Wrapper>
            </div>
        </div>
    );
